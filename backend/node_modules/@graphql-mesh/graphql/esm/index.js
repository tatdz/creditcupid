import { buildASTSchema, buildClientSchema, buildSchema, getIntrospectionQuery, GraphQLSchema, Kind, parse, print, visit, } from 'graphql';
...
import { getInterpolatedHeadersFactory, getInterpolatedStringFactory, parseInterpolationStrings, stringInterpolator, } from '@graphql-mesh/string-interpolation';
    ...
    async getNonExecutableSchemaForHTTPSource(httpSourceConfig) {
        ...
        return this.nonExecutableSchema.getWithSet(async () => {
            ...
            if (introspection.data.__schema.types.find(t => t.name === '_Service')) {
                ...
                const schema = buildSchema(sdl.data._service.sdl.replace(/extend type (\w+)/g, 'type $1 @extends'), {
                    assumeValid: true,
                    assumeValidSDL: true,
                });
                return schema;
