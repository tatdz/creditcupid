...
function mergeResults(results) {
  ...
  if (datas.length) {
    ...
    return makeExternalObject(mergeDeep(datas, void 0, true, true), errors);
  }
  if (errors.length) {
    if (errors.length === 1) {
      throw errors[0];
