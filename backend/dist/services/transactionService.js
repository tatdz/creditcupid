...
class TransactionService {
    ...
    async checkTransactionStatusBlockscout(txHash) {
        try {
    ...
    async checkTransactionStatusEtherscan(txHash) {
        try {
    ...
    async checkTransactionStatusRpc(txHash) {
        try {
    ...
    async checkTransactionStatusBasic(txHash) {
        try {
...
exports.transactionService = TransactionService.getInstance();
