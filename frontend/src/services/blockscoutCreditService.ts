// src/services/blockscoutCreditService.ts (frontend version)
...
export class BlockscoutCreditService {
  ...
  constructor() {
    // For frontend, we'll set these via setApiKeys method
