...
function z(u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  ...
  if (null === C3)
    ...
    if (f3 = f3 && n.call(u3.childNodes), b3 = i3.props || h, !c3 && null != f3)
      for (b3 = {}, a3 = 0; a3 < u3.attributes.length; a3++)
        b3[(_3 = u3.attributes[a3]).name] = _3.value;
    for (a3 in b3)
      if (_3 = b3[a3], "children" == a3)
        ;
    ...
    for (a3 in k3)
      _3 = k3[a3], "children" == a3 ? d3 = _3 : "dangerouslySetInnerHTML" == a3 ? v3 = _3 : "value" == a3 ? g3 = _3 : "checked" == a3 ? m3 = _3 : c3 && "function" != typeof _3 || b3[a3] === _3 || A(u3, a3, _3, b3[a3], r3);
    if (v3)
...
//# sourceMappingURL=chunk-E7JPLC6Z.js.map
