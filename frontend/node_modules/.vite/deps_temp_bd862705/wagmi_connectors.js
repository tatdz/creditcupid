import {
  ...
  call_exports,
  mini_exports
} from "./chunk-BXVIW46Y.js";
import "./chunk-AZYCCEVO.js";
import "./chunk-BJHDGEZH.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-7WDSMNWQ.js");
    ...
    return {
      ...
      async getProvider() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./_dist-N3JFKPWD.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-J6KEFYXW.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-B3KPFWX4.js");
