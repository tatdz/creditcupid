...
import "./chunk-IB6BO2B6.js";
import "./chunk-63Q66FHI.js";
import "./chunk-PYKJJIEJ.js";
import "./chunk-Y5JN24GD.js";
import {
  toHex
  ...
  for (let E6 = 0; E6 < a2; s++) {
    ...
    if (f6 && p3 === ge) {
      ...
      for (let v4 = 0, m2; v4 < Bs; v4++)
        m2 = d3 + v4, y6[m2] = h4[m2] ^ l4[v4];
      E6 += ge;
      continue;
    }
    for (let d3 = 0, v4; d3 < p3; d3++)
      v4 = E6 + d3, i3[v4] = o2[v4] ^ u3[d3];
    E6 += p3;
  }
}
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c4, a2, u3, l4, f6 = 0) => {
    tt(c4), tt(a2), tt(u3);
    const h4 = u3.length;
    if (l4 === void 0 && (l4 = new Uint8Array(h4)), tt(l4), Fe(f6), f6 < 0 || f6 >= Ur)
      throw new Error("arx: counter overflow");
    if (l4.length < h4)
    ...
    if (E6 === 32)
      y6.push(p3 = Ze(c4)), d3 = As;
    else if (E6 === 16 && n2)
      p3 = new Uint8Array(32), p3.set(c4), p3.set(c4, 16), d3 = Os, y6.push(p3);
    else
  ...
  return function(c4, a2) {
    ...
    for (; !c4.eql(h4, c4.ONE); ) {
      if (c4.eql(h4, c4.ZERO))
        return c4.ZERO;
      let y6 = 1;
      for (let p3 = c4.sqr(h4); y6 < u3 && !c4.eql(p3, c4.ONE); y6++)
        p3 = c4.sqr(p3);
...
function hc(t, e, n2, r2) {
  ...
  for (let f6 = u3; f6 >= 0; f6 -= s) {
    ...
    let h4 = o2;
    for (let y6 = a2.length - 1, E6 = o2; y6 > 0; y6--)
      E6 = E6.add(a2[y6]), h4 = h4.add(E6);
    if (l4 = l4.add(h4), f6 !== 0)
...
function rr2(r2, e) {
  ...
  function d3(u3) {
    ...
    if (u3.length === 0)
      return "";
    for (var b4 = 0, x3 = 0, I3 = 0, D3 = u3.length; I3 !== D3 && u3[I3] === 0; )
      I3++, b4++;
    for (var j3 = (D3 - I3) * l4 + 1 >>> 0, T2 = new Uint8Array(j3); I3 !== D3; ) {
      for (var q3 = u3[I3], J3 = 0, K4 = j3 - 1; (q3 !== 0 || J3 < x3) && K4 !== -1; K4--, J3++)
        q3 += 256 * T2[K4] >>> 0, T2[K4] = q3 % a2 >>> 0, q3 = q3 / a2 >>> 0;
      if (q3 !== 0)
        throw new Error("Non-zero carry");
      x3 = J3, I3++;
    }
    for (var H3 = j3 - x3; H3 !== j3 && T2[H3] === 0; )
      H3++;
    for (var me4 = c4.repeat(b4); H3 < j3; ++H3)
      me4 += r2.charAt(T2[H3]);
    return me4;
  }
  function g(u3) {
    ...
    var b4 = 0;
    if (u3[b4] !== " ") {
      for (var x3 = 0, I3 = 0; u3[b4] === c4; )
        x3++, b4++;
      for (var D3 = (u3.length - b4) * h4 + 1 >>> 0, j3 = new Uint8Array(D3); u3[b4]; ) {
        var T2 = t[u3.charCodeAt(b4)];
        if (T2 === 255)
          return;
        for (var q3 = 0, J3 = D3 - 1; (T2 !== 0 || q3 < I3) && J3 !== -1; J3--, q3++)
          T2 += a2 * j3[J3] >>> 0, j3[J3] = T2 % 256 >>> 0, T2 = T2 / 256 >>> 0;
        if (T2 !== 0)
          throw new Error("Non-zero carry");
        I3 = q3, b4++;
      }
      if (u3[b4] !== " ") {
        for (var K4 = D3 - I3; K4 !== D3 && j3[K4] === 0; )
          K4++;
        for (var H3 = new Uint8Array(x3 + (D3 - K4)), me4 = x3; K4 !== D3; )
          H3[me4++] = j3[K4++];
        return H3;
      }
    }
...
var Ns2 = class extends V {
  constructor(n2) {
    super(n2), c3(this, "name", dt2), c3(this, "events", new import_events4.default()), c3(this, "initialized", false), c3(this, "requestQueue", { state: $2.idle, queue: [] }), c3(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c3(this, "requestQueueDelay", import_time3.ONE_SECOND), c3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedLimit", 200), c3(this, "relayMessageCache", []), c3(this, "pendingSessions", /* @__PURE__ */ new Map()), c3(this, "init", async () => {
      ...
      if (w2)
        return await this.sendRequest({ clientRpcId: a2, relayRpcId: l4, topic: i3, method: d3, params: { request: b2(v3({}, s), { expiryTimestamp: Ei(r2) }), chainId: t }, expiry: r2, throwOnFailedPublish: true, appLink: w2 }).catch((_2) => u3(_2)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), await p3();
      ...
      try {
        if (i3) {
          ...
          await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K4, expiry: e.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q3, expiry: N2.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q3.id })]);
      } catch (x3) {
      ...
      if (!Et(i3) && Oe(i3) !== 0 && this.validateNamespaces(i3, "optionalNamespaces"), Et(r2) || this.validateSessionProps(r2, "sessionProperties"), !Et(o2)) {
        ...
        if (!Object.keys(o2).every((p3) => l4.includes(p3)))
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-DPOMYHVB.js");
      await import("./w3m-modal-575W7V44.js");
...
*/
//# sourceMappingURL=core-O2SNF7XZ.js.map
