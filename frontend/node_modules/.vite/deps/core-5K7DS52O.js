...
import "./chunk-3OYSZW37.js";
import "./chunk-M73S5BHG.js";
import "./chunk-632RNAPF.js";
import {
  HashMD
} from "./chunk-ELUEV7HT.js";
import {
  LruMap,
  checksumAddress,
  defineFormatter,
...
import "./chunk-YEKX4O3F.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-GWV3QYEC.js";
import "./chunk-7G5B3FZZ.js";
import "./chunk-QEDTBV22.js";
import {
  toHex
} from "./chunk-V3AKU2UL.js";
import "./chunk-I2TQVZFP.js";
import "./chunk-YU6FU6IJ.js";
import "./chunk-FC43JDF4.js";
import {
  __toESM
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-CHU6XKIT.js");
  const signature_ = (() => {
...
function Is(t, e, n2, r2, o2, i3, s, c3) {
  ...
  for (let E5 = 0; E5 < a2; s++) {
    ...
    if (f6 && p3 === ge) {
      ...
      for (let v4 = 0, m2; v4 < Bs; v4++)
        m2 = d3 + v4, y5[m2] = h4[m2] ^ l3[v4];
      E5 += ge;
      continue;
    }
    for (let d3 = 0, v4; d3 < p3; d3++)
      v4 = E5 + d3, i3[v4] = o2[v4] ^ u3[d3];
    E5 += p3;
  }
}
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c3, a2, u3, l3, f6 = 0) => {
    tt(c3), tt(a2), tt(u3);
    const h4 = u3.length;
    if (l3 === void 0 && (l3 = new Uint8Array(h4)), tt(l3), Fe(f6), f6 < 0 || f6 >= Ur)
      throw new Error("arx: counter overflow");
    if (l3.length < h4)
    ...
    if (E5 === 32)
      y5.push(p3 = Ze(c3)), d3 = As;
    else if (E5 === 16 && n2)
      p3 = new Uint8Array(32), p3.set(c3), p3.set(c3, 16), d3 = Os, y5.push(p3);
    else
      throw new Error(`arx: invalid 32-byte key, got length=${E5}`);
...
var qs = class extends ke {
  ...
  digestInto(e) {
    ...
    for (let f6 = 0; f6 < u3; f6++)
      c3.setUint32(4 * f6, l3[f6], i3);
  }
  digest() {
    const { buffer: e, outputLen: n2 } = this;
    this.digestInto(e);
  ...
  return function(c3, a2) {
    ...
    for (; !c3.eql(h4, c3.ONE); ) {
      if (c3.eql(h4, c3.ZERO))
        return c3.ZERO;
      let y5 = 1;
      for (let p3 = c3.sqr(h4); y5 < u3 && !c3.eql(p3, c3.ONE); y5++)
        p3 = c3.sqr(p3);
...
function hc(t, e, n2, r2) {
  ...
  for (let f6 = u3; f6 >= 0; f6 -= s) {
    ...
    let h4 = o2;
    for (let y5 = a2.length - 1, E5 = o2; y5 > 0; y5--)
      E5 = E5.add(a2[y5]), h4 = h4.add(E5);
    if (l3 = l3.add(h4), f6 !== 0)
...
function Ac(t) {
  ...
  function a2(p3) {
    ...
    if (d3 && typeof p3 != "bigint") {
      if (St(p3) && (p3 = Pt(p3)), typeof p3 != "string" || !d3.includes(p3.length))
  ...
  const l3 = tn((p3, d3) => {
    ...
    if (p3.is0()) {
      if (e.allowInfinityPoint && !n2.is0(p3.py))
        return;
      throw new Error("bad point: ZERO");
    }
    const { x: d3, y: v4 } = p3.toAffine();
    if (!n2.isValid(d3) || !n2.isValid(v4))
  ...
  class h4 {
    constructor(d3, v4, m2) {
      if (this.px = d3, this.py = v4, this.pz = m2, d3 == null || !n2.isValid(d3))
        throw new Error("x required");
      if (v4 == null || !n2.isValid(v4))
    ...
    static fromAffine(d3) {
      const { x: v4, y: m2 } = d3 || {};
      if (!d3 || !n2.isValid(v4) || !n2.isValid(m2))
    ...
    multiplyUnsafe(d3) {
      ...
      if (this.is0() || d3 === K)
        return this;
      if (!v4 || E5.hasPrecomputes(this))
        return E5.wNAFCachedUnsafe(this, d3, h4.normalizeZ);
      let { k1neg: N3, k1: $4, k2neg: B3, k2: A4 } = v4.splitScalar(d3), T2 = O4, S4 = O4, L3 = this;
      for (; $4 > dt || A4 > dt; )
        $4 & K && (T2 = T2.add(L3)), A4 & K && (S4 = S4.add(L3)), L3 = L3.double(), $4 >>= K, A4 >>= K;
...
function Ic(t) {
  ...
  function S4(g, w2, b4 = L3) {
    if (["recovered", "canonical"].some((W3) => W3 in b4))
  ...
  function j2(g, w2, b4, I3 = U4) {
    ...
    if (Jr(I3), "strict" in I3)
      throw new Error("options.strict was renamed to lowS");
    if (P3 !== void 0 && P3 !== "compact" && P3 !== "der")
...
function rr2(r2, e) {
  ...
  function d3(u3) {
    ...
    if (u3.length === 0)
      return "";
    for (var b4 = 0, x2 = 0, I3 = 0, D2 = u3.length; I3 !== D2 && u3[I3] === 0; )
      I3++, b4++;
    for (var j2 = (D2 - I3) * l3 + 1 >>> 0, T2 = new Uint8Array(j2); I3 !== D2; ) {
      for (var q3 = u3[I3], J3 = 0, K3 = j2 - 1; (q3 !== 0 || J3 < x2) && K3 !== -1; K3--, J3++)
        q3 += 256 * T2[K3] >>> 0, T2[K3] = q3 % a2 >>> 0, q3 = q3 / a2 >>> 0;
      if (q3 !== 0)
        throw new Error("Non-zero carry");
      x2 = J3, I3++;
    }
    for (var H3 = j2 - x2; H3 !== j2 && T2[H3] === 0; )
      H3++;
    for (var me4 = c3.repeat(b4); H3 < j2; ++H3)
      me4 += r2.charAt(T2[H3]);
    return me4;
  }
  function g(u3) {
    ...
    if (u3[b4] !== " ") {
      ...
      if (u3[b4] !== " ") {
        for (var K3 = D2 - I3; K3 !== D2 && j2[K3] === 0; )
          K3++;
        for (var H3 = new Uint8Array(x2 + (D2 - K3)), me4 = x2; K3 !== D2; )
          H3[me4++] = j2[K3++];
        return H3;
      }
    }
    ...
    super(e, t, i3), this.core = e, this.logger = t, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      try {
        const h4 = (0, import_window_getters2.getDocument)(), l3 = this.startAbortTimer(import_time2.ONE_SECOND * 5), d3 = await new Promise((g, _) => {
          ...
          const x2 = (I3) => {
            if (I3.data && typeof I3.data == "string")
              try {
                const D2 = JSON.parse(I3.data);
                if (D2.type === "verify_attestation") {
                  if (sn(D2.attestation).payload.id !== o2)
                    return;
...
var v3 = (S4, n2) => {
  for (var e in n2 || (n2 = {}))
    qs3.call(n2, e) && Ue2(S4, e, n2[e]);
  if (ft2)
    for (var e of ft2(n2))
      Ps2.call(n2, e) && Ue2(S4, e, n2[e]);
  return S4;
};
...
var Ns2 = class extends V {
  constructor(n2) {
    super(n2), c2(this, "name", dt2), c2(this, "events", new import_events4.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time3.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      if (w2)
        return await this.sendRequest({ clientRpcId: a2, relayRpcId: l3, topic: i3, method: d3, params: { request: b2(v3({}, s), { expiryTimestamp: Ei(r2) }), chainId: t }, expiry: r2, throwOnFailedPublish: true, appLink: w2 }).catch((_) => u3(_)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), await p3();
      ...
      try {
        if (i3) {
          ...
          await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K3, expiry: e.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q3, expiry: N.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q3.id })]);
      } catch (x2) {
      ...
      if (!Et(i3) && Oe(i3) !== 0 && this.validateNamespaces(i3, "optionalNamespaces"), Et(r2) || this.validateSessionProps(r2, "sessionProperties"), !Et(o2)) {
        ...
        if (!Object.keys(o2).every((p3) => l3.includes(p3)))
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-O3PUVGBH.js");
      await import("./w3m-modal-HZZ27G23.js");
...
*/
//# sourceMappingURL=core-5K7DS52O.js.map
