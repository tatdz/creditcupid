...
function __decorate(decorators, target, key, desc) {
  ...
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    for (var i3 = decorators.length - 1; i3 >= 0; i3--)
      if (d4 = decorators[i3])
        r3 = (c5 < 3 ? d4(r3) : c5 > 3 ? d4(target, key, r3) : d4(target, key)) || r3;
...
var __spreadArray = function(to2, from3, pack) {
  if (pack || arguments.length === 2)
    for (var i3 = 0, l6 = from3.length, ar2; i3 < l6; i3++) {
      if (ar2 || !(i3 in from3)) {
        if (!ar2)
...
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l6 = 0; l6 < D2; l6++)
      u.setUint32(4 * l6, c5[l6], s3);
  }
  digest() {
  ...
  return function(u, i3) {
    ...
    for (; !u.eql(p3, u.ONE); ) {
      if (u.eql(p3, u.ZERO))
        return u.ZERO;
      let w4 = 1;
      for (let g4 = u.sqr(p3); w4 < D2 && !u.eql(g4, u.ONE); w4++)
        g4 = u.sqr(g4);
  ...
  return { constTimeNegate: zt, hasPrecomputes(n4) {
    ...
    for (let l6 = 0; l6 < a2; l6++) {
      ...
      if (o5 === Se)
        break;
      let w4 = Number(o5 & i3);
      if (o5 >>= c5, w4 > u && (w4 -= D2, o5 += gt), w4 === 0)
        continue;
...
function br(t, e2, n4, r3) {
  ...
  for (let l6 = D2; l6 >= 0; l6 -= a2) {
    ...
    let p3 = o5;
    for (let w4 = i3.length - 1, h4 = o5; w4 > 0; w4--)
      h4 = h4.add(i3[w4]), p3 = p3.add(h4);
    if (c5 = c5.add(p3), l6 !== 0)
...
function Ir(t, e2) {
  ...
  function l6(h4) {
    ...
    if (h4.length === 0)
      return "";
    for (var g4 = 0, S2 = 0, v4 = 0, L3 = h4.length; v4 !== L3 && h4[v4] === 0; )
      v4++, g4++;
    for (var d4 = (L3 - v4) * c5 + 1 >>> 0, m3 = new Uint8Array(d4); v4 !== L3; ) {
      for (var F = h4[v4], q = 0, z3 = d4 - 1; (F !== 0 || q < S2) && z3 !== -1; z3--, q++)
        F += 256 * m3[z3] >>> 0, m3[z3] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0)
        throw new Error("Non-zero carry");
      S2 = q, v4++;
    }
    for (var I2 = d4 - S2; I2 !== d4 && m3[I2] === 0; )
      I2++;
    for (var O4 = i3.repeat(g4); I2 < d4; ++I2)
      O4 += t.charAt(m3[I2]);
    return O4;
  }
  function p3(h4) {
    ...
    if (h4[g4] !== " ") {
      ...
      if (h4[g4] !== " ") {
        for (var z3 = L3 - v4; z3 !== L3 && d4[z3] === 0; )
          z3++;
        for (var I2 = new Uint8Array(S2 + (L3 - z3)), O4 = S2; z3 !== L3; )
          I2[O4++] = d4[z3++];
        return I2;
      }
    }
...
*/
//# sourceMappingURL=chunk-NL5T3APM.js.map
