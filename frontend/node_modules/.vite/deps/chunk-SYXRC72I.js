...
var ICONS = {
  add: async () => (await import("./add-C7DYJ2SP.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-LWDYK5HN.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-BKKZYCFP.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-7V75SH4Q.js")).appStoreSvg,
  apple: async () => (await import("./apple-RSGFY3BO.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-QAG25RU4.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-I2JICBIR.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-SGK52PLU.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-FRKIJNR7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-A2JR4TSW.js")).bankSvg,
  browser: async () => (await import("./browser-BMBE6QXF.js")).browserSvg,
  card: async () => (await import("./card-KLDME7TH.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-RYOKS3Z7.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-IFCLRA67.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DMKBWRAB.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-7MNOD36K.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-FLOIAOCW.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-7FQMVEN5.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-XCBX42NL.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ACIG57PB.js")).clockSvg,
  close: async () => (await import("./close-JJVTPCJQ.js")).closeSvg,
  compass: async () => (await import("./compass-NUUDFZR6.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-2XVRMYUK.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-VYMIJ4MW.js")).copySvg,
  cursor: async () => (await import("./cursor-T2RQGP4V.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-QGTXVNTN.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CHBR5RB4.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-LAY2TINX.js")).disconnectSvg,
  discord: async () => (await import("./discord-TAWS4JAS.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-Y2YQ2T54.js")).etherscanSvg,
  extension: async () => (await import("./extension-YFKREOJV.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-2UQQIJ6Z.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HIR23WEF.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-K37DSGKD.js")).farcasterSvg,
  filters: async () => (await import("./filters-FWWAMB2J.js")).filtersSvg,
  github: async () => (await import("./github-OO3NENLU.js")).githubSvg,
  google: async () => (await import("./google-M7QGZJEZ.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-MMTUWPJX.js")).helpCircleSvg,
  image: async () => (await import("./image-QZCFHD2Z.js")).imageSvg,
  id: async () => (await import("./id-EZ5G36B7.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-W24VJM74.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-XSMOJHN7.js")).lightbulbSvg,
  mail: async () => (await import("./mail-XZ2QYK74.js")).mailSvg,
  mobile: async () => (await import("./mobile-MDWTQQBE.js")).mobileSvg,
  more: async () => (await import("./more-TDTHR47U.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-GL63GREC.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-4HYCNSNI.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-4GCGJBOJ.js")).offSvg,
  playStore: async () => (await import("./play-store-A5KDNZIW.js")).playStoreSvg,
  plus: async () => (await import("./plus-A55VNYOM.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-QVEGIMD5.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-5MHXFIEA.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-BPVFTNLC.js")).refreshSvg,
  search: async () => (await import("./search-L2I4ZL3S.js")).searchSvg,
  send: async () => (await import("./send-VQRRWNQN.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-VRMVWVSS.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-UJF3D7QM.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-3VJIORSL.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-N6ETSXV3.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-USJPWANA.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-DEGTSONN.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-XQO7O7DE.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-EBSMFNNC.js")).twitchSvg,
  twitter: async () => (await import("./x-DMCUQE4J.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-M5MKFY7V.js")).twitterIconSvg,
  verify: async () => (await import("./verify-E4D346PX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-32DCV72G.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-HNDIRVZN.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-SZYKJP72.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-SZYKJP72.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-SZYKJP72.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SMQU4OTM.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-NELNLFFR.js")).warningCircleSvg,
  x: async () => (await import("./x-DMCUQE4J.js")).xSvg,
  info: async () => (await import("./info-AKBZGL7E.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-CIAJPW4O.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-SDNRQTUZ.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SYXRC72I.js.map
