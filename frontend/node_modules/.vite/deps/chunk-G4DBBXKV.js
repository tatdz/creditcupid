...
function __decorate(decorators, target, key, desc) {
  ...
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    for (var i3 = decorators.length - 1; i3 >= 0; i3--)
      if (d4 = decorators[i3])
        r3 = (c4 < 3 ? d4(r3) : c4 > 3 ? d4(target, key, r3) : d4(target, key)) || r3;
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_2)
      try {
        if (f4 = 1, y2 && (t = op[0] & 2 ? y2["return"] : op[0] ? y2["throw"] || ((t = y2["return"]) && t.call(y2), 0) : y2.next) && !(t = t.call(y2, op[1])).done)
          return t;
        if (y2 = 0, t)
          op = [op[0] & 2, t.value];
        switch (op[0]) {
...
var __spreadArray = function(to2, from3, pack) {
  if (pack || arguments.length === 2)
    for (var i3 = 0, l5 = from3.length, ar2; i3 < l5; i3++) {
      if (ar2 || !(i3 in from3)) {
        if (!ar2)
...
function Cn(t, e2, n4, r3) {
  if (typeof t.setBigUint64 == "function")
    return t.setBigUint64(e2, n4, r3);
...
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l5 = 0; l5 < D; l5++)
      u.setUint32(4 * l5, c4[l5], s3);
  }
  digest() {
...
var Jn = class extends An {
  ...
  process(e2, n4) {
    for (let d4 = 0; d4 < 16; d4++, n4 += 4)
      P[d4] = e2.getUint32(n4), Q[d4] = e2.getUint32(n4 += 4);
...
function W(t, e2, n4) {
  ...
  const o5 = r3.length;
  if (typeof n4 == "number" && o5 !== n4)
    throw new Error(t + " of length " + n4 + " expected, got " + o5);
  return r3;
}
function ye(...t) {
  let e2 = 0;
...
function ft(t, e2, n4, r3) {
  if (!Qn(e2, n4, r3))
    throw new Error("expected valid " + t + ": " + n4 + " <= n < " + r3 + ", got " + e2);
}
function tr(t) {
  let e2;
...
function Ot(t, e2, n4 = {}) {
  const r3 = (o5, s3, a2) => {
    ...
    const i3 = t[o5];
    if (!(a2 && i3 === void 0) && !u(i3, t))
      throw new Error("param " + String(o5) + " is invalid. Expected " + s3 + ", got " + i3);
  };
  for (const [o5, s3] of Object.entries(e2))
    r3(o5, s3, false);
  for (const [o5, s3] of Object.entries(n4))
    r3(o5, s3, true);
  return t;
}
function xe(t) {
...
function sr(t) {
  ...
  for (n4 = t - N, r3 = 0; n4 % nt === M; n4 /= nt, r3++)
    ;
  for (o5 = nt; o5 < t && or(o5, e2, t) !== t - N; o5++)
    if (o5 > 1e3)
  ...
  return function(u, i3) {
    ...
    for (; !u.eql(p3, u.ONE); ) {
      if (u.eql(p3, u.ZERO))
        return u.ZERO;
      let w4 = 1;
      for (let g4 = u.sqr(p3); w4 < D && !u.eql(g4, u.ONE); w4++)
        g4 = u.sqr(g4);
...
function fr(t, e2, n4) {
  ...
  let r3 = t.ONE, o5 = e2;
  for (; n4 > M; )
    n4 & N && (r3 = t.mul(r3, o5)), o5 = t.sqr(o5), n4 >>= N;
  return r3;
}
function Dr(t, e2) {
...
function _e(t, e2, n4 = false, r3 = {}) {
  ...
  const u = Object.freeze({ ORDER: t, isLE: n4, BITS: o5, BYTES: s3, MASK: er(o5), ZERO: M, ONE: N, create: (i3) => H(i3, t), isValid: (i3) => {
    ...
    if (i3.length !== s3)
      throw new Error("Field.fromBytes: expected " + s3 + " bytes, got " + i3.length);
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n4) {
    ...
    for (let D = 0; D < o5; D++) {
      i3 = u, a2.push(i3);
      for (let c4 = 1; c4 < s3; c4++)
        i3 = i3.add(u), a2.push(i3);
      u = i3.double();
    }
    return a2;
  }, wNAF(n4, r3, o5) {
...
function br(t, e2, n4, r3) {
  if (dr(n4, t), hr(r3, e2), n4.length !== r3.length)
  ...
  for (let l5 = D; l5 >= 0; l5 -= a2) {
    ...
    let p3 = o5;
    for (let w4 = i3.length - 1, h3 = o5; w4 > 0; w4--)
      h3 = h3.add(i3[w4]), p3 = p3.add(h3);
    if (c4 = c4.add(p3), l5 !== 0)
...
function Ir(t, e2) {
  ...
  function l5(h3) {
    if (h3 instanceof Uint8Array || (ArrayBuffer.isView(h3) ? h3 = new Uint8Array(h3.buffer, h3.byteOffset, h3.byteLength) : Array.isArray(h3) && (h3 = Uint8Array.from(h3))), !(h3 instanceof Uint8Array))
      throw new TypeError("Expected Uint8Array");
    if (h3.length === 0)
      return "";
    for (var g4 = 0, S2 = 0, v4 = 0, L3 = h3.length; v4 !== L3 && h3[v4] === 0; )
      v4++, g4++;
    for (var d4 = (L3 - v4) * c4 + 1 >>> 0, m3 = new Uint8Array(d4); v4 !== L3; ) {
      for (var F = h3[v4], q = 0, z2 = d4 - 1; (F !== 0 || q < S2) && z2 !== -1; z2--, q++)
        F += 256 * m3[z2] >>> 0, m3[z2] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0)
        throw new Error("Non-zero carry");
      S2 = q, v4++;
    }
    for (var I2 = d4 - S2; I2 !== d4 && m3[I2] === 0; )
      I2++;
    for (var O3 = i3.repeat(g4); I2 < d4; ++I2)
      O3 += t.charAt(m3[I2]);
    return O3;
  }
  function p3(h3) {
    ...
    var g4 = 0;
    if (h3[g4] !== " ") {
      for (var S2 = 0, v4 = 0; h3[g4] === i3; )
        S2++, g4++;
      for (var L3 = (h3.length - g4) * D + 1 >>> 0, d4 = new Uint8Array(L3); h3[g4]; ) {
        var m3 = n4[h3.charCodeAt(g4)];
        if (m3 === 255)
          return;
        for (var F = 0, q = L3 - 1; (m3 !== 0 || F < v4) && q !== -1; q--, F++)
          m3 += u * d4[q] >>> 0, d4[q] = m3 % 256 >>> 0, m3 = m3 / 256 >>> 0;
        if (m3 !== 0)
          throw new Error("Non-zero carry");
        v4 = F, g4++;
      }
      if (h3[g4] !== " ") {
        for (var z2 = L3 - v4; z2 !== L3 && d4[z2] === 0; )
          z2++;
...
var Or = class {
  constructor(e2, n4, r3) {
    if (this.name = e2, this.prefix = n4, n4.codePointAt(0) === void 0)
...
var qr = (t, e2, n4) => {
  ...
  for (let i3 = 0; i3 < t.length; ++i3)
    for (u = u << 8 | t[i3], a2 += 8; a2 > n4; )
      a2 -= n4, s3 += e2[o5 & u >> a2];
  if (a2 && (s3 += e2[o5 & u << n4 - a2]), r3)
    for (; s3.length * n4 & 7; )
      s3 += "=";
  return s3;
};
...
var te = We("ascii", "a", (t) => {
  let e2 = "a";
  for (let n4 = 0; n4 < t.length; n4++)
    e2 += String.fromCharCode(t[n4]);
  return e2;
}, (t) => {
  t = t.substring(1);
  const e2 = Le(t.length);
  for (let n4 = 0; n4 < t.length; n4++)
    e2[n4] = t.charCodeAt(n4);
  return e2;
});
...
*/
//# sourceMappingURL=chunk-G4DBBXKV.js.map
