...
import {
  ...
  numberToHex,
  toHex
} from "./chunk-Y6VMZSCO.js";
import {
  require_events
} from "./chunk-ZX2HK32R.js";
import {
  HashMD
} from "./chunk-2S5VEKQY.js";
import {
  rotl,
  wrapConstructor
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-DBFK7RFL.js");
  const signature_ = (() => {
...
var _n = (t, e) => {
  for (var n2 in e || (e = {}))
    Wo.call(e, n2) && Rn(t, n2, e[n2]);
  if (Tn)
    for (var n2 of Tn(e))
      Xo.call(e, n2) && Rn(t, n2, e[n2]);
  return t;
};
...
async function Si({ id: t, topic: e, wcDeepLink: n2 }) {
  ...
  try {
    ...
    if (c3 === Y.browser) {
      ...
      c3 === Y.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
  } catch (o2) {
    console.error(o2);
  }
}
...
async function Oi(t, e) {
  let n2 = "";
  try {
    if (Tt() && (n2 = localStorage.getItem(e), n2))
      return n2;
...
function Lt(t = 32) {
  ...
  if (_t && typeof _t.randomBytes == "function")
    return _t.randomBytes(t);
...
for (let t = 0, e = Jt, n2 = 1, r2 = 0; t < 24; t++) {
  ...
  for (let i3 = 0; i3 < 7; i3++)
    e = (e << Jt ^ (e >> Hi) * Ki) % qi, e & Di && (o2 ^= Jt << (Jt << BigInt(i3)) - Jt);
  nr.push(o2);
}
...
var En = class _En extends ke {
  constructor(e, n2, r2, o2 = false, i3 = 24) {
    if (super(), this.blockLen = e, this.suffix = n2, this.outputLen = r2, this.enableXOF = o2, this.rounds = i3, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Wt(r2), 0 >= this.blockLen || this.blockLen >= 200)
...
var Me = (t, e) => {
  for (var n2 in e || (e = {}))
    ns.call(e, n2) && ur(t, n2, e[n2]);
  if (ar)
    for (var n2 of ar(e))
      rs.call(e, n2) && ur(t, n2, e[n2]);
  return t;
};
...
var Es = (t, e) => {
  function n2(r2, ...o2) {
    ...
    return { encrypt(l3, f7) {
      ...
      if (tt(l3), i3 && l3.length < i3)
        throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
...
function Is(t, e, n2, r2, o2, i3, s, c3) {
  ...
  for (let E6 = 0; E6 < a2; s++) {
    ...
    if (f7 && p4 === ge) {
      ...
      for (let v5 = 0, m2; v5 < Bs; v5++)
        m2 = d3 + v5, y5[m2] = h4[m2] ^ l3[v5];
      E6 += ge;
      continue;
    }
    for (let d3 = 0, v5; d3 < p4; d3++)
      v5 = E6 + d3, i3[v5] = o2[v5] ^ u3[d3];
    E6 += p4;
  }
}
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c3, a2, u3, l3, f7 = 0) => {
    tt(c3), tt(a2), tt(u3);
    const h4 = u3.length;
    if (l3 === void 0 && (l3 = new Uint8Array(h4)), tt(l3), Fe(f7), f7 < 0 || f7 >= Ur)
      throw new Error("arx: counter overflow");
    if (l3.length < h4)
      throw new Error(`arx: output (${l3.length}) is shorter than data (${h4})`);
    const y5 = [];
    let E6 = c3.length, p4, d3;
    if (E6 === 32)
      y5.push(p4 = Ze(c3)), d3 = As;
    else if (E6 === 16 && n2)
      p4 = new Uint8Array(32), p4.set(c3), p4.set(c3, 16), d3 = Os, y5.push(p4);
    else
      throw new Error(`arx: invalid 32-byte key, got length=${E6}`);
...
var Us = class {
  ...
  finalize() {
    ...
    let s = e[0] + n2[0];
    e[0] = s & 65535;
    for (let c3 = 1; c3 < 8; c3++)
      s = (e[c3] + n2[c3] | 0) + (s >>> 16) | 0, e[c3] = s & 65535;
    jt(r2);
  }
  update(e) {
    Or(this);
...
function ks(t, e, n2, r2 = 32) {
  if (Ce(t), Wt(r2), r2 > 255 * t.outputLen)
  ...
  for (let u3 = 0; u3 < o2; u3++)
    Ge[0] = u3 + 1, c3.update(u3 === 0 ? jr : a2).update(n2).update(Ge).digestInto(a2), i3.set(a2, t.outputLen * u3), s._cloneInto(c3);
...
var qs = class extends ke {
  ...
  digestInto(e) {
    ...
    for (let f7 = 0; f7 < u3; f7++)
      c3.setUint32(4 * f7, l3[f7], i3);
  }
  digest() {
    const { buffer: e, outputLen: n2 } = this;
    this.digestInto(e);
...
var Fs = class extends qs {
  ...
  process(e, n2) {
    for (let f7 = 0; f7 < 16; f7++, n2 += 4)
      bt[f7] = e.getUint32(n2, false);
...
function Dt(t, e, n2 = {}) {
  const r2 = (o2, i3, s) => {
    ...
    const a2 = t[o2];
    if (!(s && a2 === void 0) && !c3(a2, t))
      throw new Error("param " + String(o2) + " is invalid. Expected " + i3 + ", got " + a2);
  };
  for (const [o2, i3] of Object.entries(e))
    r2(o2, i3, false);
  for (const [o2, i3] of Object.entries(n2))
    r2(o2, i3, true);
  return t;
}
var tc = () => {
...
function rc(t) {
  ...
  for (n2 = t - H, r2 = 0; n2 % At === q; n2 /= At, r2++)
    ;
  for (o2 = At; o2 < t && Hr(o2, e, t) !== t - H; o2++)
    if (o2 > 1e3)
  ...
  return function(c3, a2) {
    if (c3.pow(a2, e) === c3.neg(c3.ONE))
      throw new Error("Cannot find square root");
    let u3 = r2, l3 = c3.pow(c3.mul(c3.ONE, o2), n2), f7 = c3.pow(a2, i3), h4 = c3.pow(a2, n2);
    for (; !c3.eql(h4, c3.ONE); ) {
      if (c3.eql(h4, c3.ZERO))
        return c3.ZERO;
      let y5 = 1;
      for (let p4 = c3.sqr(h4); y5 < u3 && !c3.eql(p4, c3.ONE); y5++)
        p4 = c3.sqr(p4);
...
function cc(t, e, n2) {
  ...
  let r2 = t.ONE, o2 = e;
  for (; n2 > q; )
    n2 & H && (r2 = t.mul(r2, o2)), o2 = t.sqr(o2), n2 >>= H;
  return r2;
}
function ac(t, e) {
...
function Kr2(t, e, n2 = false, r2 = {}) {
  ...
  const c3 = Object.freeze({ ORDER: t, isLE: n2, BITS: o2, BYTES: i3, MASK: Je(o2), ZERO: q, ONE: H, create: (a2) => X(a2, t), isValid: (a2) => {
    if (typeof a2 != "bigint")
      throw new Error("invalid field element: expected bigint, got " + typeof a2);
    return q <= a2 && a2 < t;
    ...
    if (a2.length !== i3)
      throw new Error("Field.fromBytes: expected " + i3 + " bytes, got " + a2.length);
...
function uc(t, e, n2 = false) {
  ...
  if (r2 < 16 || r2 < i3 || r2 > 1024)
    throw new Error("expected " + i3 + "-1024 bytes of input, got " + r2);
...
function dc(t, e) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    let i3 = n2;
    for (; r2 > Zr; )
      r2 & ve && (o2 = o2.add(i3)), i3 = i3.double(), r2 >>= ve;
    return o2;
    ...
    for (let u3 = 0; u3 < o2; u3++) {
      a2 = c3, s.push(a2);
      for (let l3 = 1; l3 < i3; l3++)
        a2 = a2.add(c3), s.push(a2);
      c3 = a2.double();
    }
    return s;
  }, wNAF(n2, r2, o2) {
    ...
    for (let f7 = 0; f7 < s; f7++) {
      ...
      if (o2 === Zr)
        break;
      let y5 = Number(o2 & a2);
      if (o2 >>= l3, y5 > c3 && (y5 -= u3, o2 += ve), y5 === 0)
        continue;
...
function hc(t, e, n2, r2) {
  if (fc(n2, t), lc(r2, e), n2.length !== r2.length)
  ...
  for (let f7 = u3; f7 >= 0; f7 -= s) {
    ...
    let h4 = o2;
    for (let y5 = a2.length - 1, E6 = o2; y5 > 0; y5--)
      E6 = E6.add(a2[y5]), h4 = h4.add(E6);
    if (l3 = l3.add(h4), f7 !== 0)
...
function vc(t) {
  ...
  if (n2) {
    if (!r2.eql(o2, r2.ZERO))
      throw new Error("invalid endomorphism, can only be defined for Koblitz curves that have a=0");
    if (typeof n2 != "object" || typeof n2.beta != "bigint" || typeof n2.splitScalar != "function")
...
function Ac(t) {
  ...
  function a2(p4) {
    ...
    if (d3 && typeof p4 != "bigint") {
      if (St(p4) && (p4 = Pt(p4)), typeof p4 != "string" || !d3.includes(p4.length))
  ...
  const l3 = tn((p4, d3) => {
    ...
    if (p4.is0()) {
      if (e.allowInfinityPoint && !n2.is0(p4.py))
        return;
      throw new Error("bad point: ZERO");
    }
    const { x: d3, y: v5 } = p4.toAffine();
    if (!n2.isValid(d3) || !n2.isValid(v5))
  ...
  class h4 {
    constructor(d3, v5, m2) {
      if (this.px = d3, this.py = v5, this.pz = m2, d3 == null || !n2.isValid(d3))
        throw new Error("x required");
      if (v5 == null || !n2.isValid(v5))
        throw new Error("y required");
      if (m2 == null || !n2.isValid(m2))
        throw new Error("z required");
      Object.freeze(this);
    }
    static fromAffine(d3) {
      const { x: v5, y: m2 } = d3 || {};
      if (!d3 || !n2.isValid(v5) || !n2.isValid(m2))
    ...
    multiplyUnsafe(d3) {
      ...
      if (this.is0() || d3 === K)
        return this;
      if (!v5 || E6.hasPrecomputes(this))
        return E6.wNAFCachedUnsafe(this, d3, h4.normalizeZ);
      let { k1neg: N3, k1: $5, k2neg: B4, k2: A5 } = v5.splitScalar(d3), T3 = O4, S5 = O4, L4 = this;
      for (; $5 > dt || A5 > dt; )
        $5 & K && (T3 = T3.add(L4)), A5 & K && (S5 = S5.add(L4)), L4 = L4.double(), $5 >>= K, A5 >>= K;
...
function Ic(t) {
  ...
  class d3 {
    ...
    recoverPublicKey(w3) {
      ...
      if (R5 == null || ![0, 1, 2, 3].includes(R5))
  ...
  function S5(g, w3, b5 = L4) {
    if (["recovered", "canonical"].some((W4) => W4 in b5))
  ...
  function j3(g, w3, b5, I4 = U5) {
    ...
    if (Jr(I4), "strict" in I4)
      throw new Error("options.strict was renamed to lowS");
    if (P4 !== void 0 && P4 !== "compact" && P4 !== "der")
...
function Vc(t) {
  ...
  if (Bt(e) === Ft && typeof t.senderPublicKey > "u")
...
function gn(t) {
  if (Bt(t.type) === re)
    return toString(concat([t.type, t.sealed]), qt);
  if (Bt(t.type) === Ft) {
...
function zc(t, e) {
  ...
  if (!_c.verify(concat([s, c3]), u3, l3))
...
var ra = (t, e) => {
  for (var n2 in e || (e = {}))
    ea.call(e, n2) && lo(t, n2, e[n2]);
  if (fo)
    for (var n2 of fo(e))
      na.call(e, n2) && lo(t, n2, e[n2]);
  return t;
};
...
function ca(t, e) {
  ...
  for (const [r2, o2] of Object.entries(n2))
    o2.methods ? o2.methods = ot(o2.methods, t) : o2.methods = t, o2.events = ["chainChanged", "accountsChanged"];
  return n2;
}
function aa(t, e) {
  ...
  for (const h4 of f7)
    l3[h4] = { chains: ot((n2 = a2[h4]) == null ? void 0 : n2.chains, (r2 = u3[h4]) == null ? void 0 : r2.chains), methods: ot((o2 = a2[h4]) == null ? void 0 : o2.methods, (i3 = u3[h4]) == null ? void 0 : i3.methods), events: ot((s = a2[h4]) == null ? void 0 : s.events, (c3 = u3[h4]) == null ? void 0 : c3.events) };
  return l3;
}
...
function pa(t, e, n2) {
  ...
  if (t && Oe(t)) {
    ...
    r2 = ht("MISSING_OR_INVALID", `${e}, ${n2} should be an object with data`);
  return r2;
}
function Bo(t, e) {
  let n2 = null;
  if (t && Oe(t)) {
    ...
    n2 = ht("MISSING_OR_INVALID", `${e}, namespaces should be an object with data`);
  return n2;
}
function Io(t) {
...
function rr2(r2, e) {
  ...
  function d3(u3) {
    ...
    if (u3.length === 0)
      return "";
    for (var b5 = 0, x2 = 0, I4 = 0, D3 = u3.length; I4 !== D3 && u3[I4] === 0; )
      I4++, b5++;
    for (var j3 = (D3 - I4) * l3 + 1 >>> 0, T3 = new Uint8Array(j3); I4 !== D3; ) {
      for (var q4 = u3[I4], J4 = 0, K4 = j3 - 1; (q4 !== 0 || J4 < x2) && K4 !== -1; K4--, J4++)
        q4 += 256 * T3[K4] >>> 0, T3[K4] = q4 % a2 >>> 0, q4 = q4 / a2 >>> 0;
      if (q4 !== 0)
        throw new Error("Non-zero carry");
      x2 = J4, I4++;
    }
    for (var H4 = j3 - x2; H4 !== j3 && T3[H4] === 0; )
      H4++;
    for (var me4 = c3.repeat(b5); H4 < j3; ++H4)
      me4 += r2.charAt(T3[H4]);
    return me4;
  }
  function g(u3) {
    ...
    var b5 = 0;
    if (u3[b5] !== " ") {
      for (var x2 = 0, I4 = 0; u3[b5] === c3; )
        x2++, b5++;
      for (var D3 = (u3.length - b5) * h4 + 1 >>> 0, j3 = new Uint8Array(D3); u3[b5]; ) {
        var T3 = t[u3.charCodeAt(b5)];
        if (T3 === 255)
          return;
        for (var q4 = 0, J4 = D3 - 1; (T3 !== 0 || q4 < I4) && J4 !== -1; J4--, q4++)
          T3 += a2 * j3[J4] >>> 0, j3[J4] = T3 % 256 >>> 0, T3 = T3 / 256 >>> 0;
        if (T3 !== 0)
          throw new Error("Non-zero carry");
        I4 = q4, b5++;
      }
      if (u3[b5] !== " ") {
        for (var K4 = D3 - I4; K4 !== D3 && j3[K4] === 0; )
          K4++;
        for (var H4 = new Uint8Array(x2 + (D3 - K4)), me4 = x2; K4 !== D3; )
          H4[me4++] = j3[K4++];
        return H4;
      }
    }
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      if (Fc(a2))
        return Dc(c3, o2 == null ? void 0 : o2.encoding);
      if (Kc(a2)) {
...
var jn2 = (r2, e) => {
  for (var t in e || (e = {}))
    Ln.call(e, t) && Ve2(r2, t, e[t]);
  if (wi2)
    for (var t of wi2(e))
      kn2.call(e, t) && Ve2(r2, t, e[t]);
  return r2;
};
...
var Ie2 = (r2, e) => {
  for (var t in e || (e = {}))
    Bn.call(e, t) && qe2(r2, t, e[t]);
  if (Ei2)
    for (var t of Ei2(e))
      Vn2.call(e, t) && qe2(r2, t, e[t]);
  return r2;
};
  ...
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i3, s, n2) => {
      ...
      try {
        ...
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(u3), (o2 = n2 == null ? void 0 : n2.internal) != null && o2.throwOnFailedPublish)
          throw u3;
      } finally {
...
var ge2 = (r2, e) => {
  for (var t in e || (e = {}))
    Zn2.call(e, t) && We2(r2, t, e[t]);
  if (Ii2)
    for (var t of Ii2(e))
      Qn2.call(e, t) && We2(r2, t, e[t]);
  return r2;
};
...
var Ti2 = class extends P {
  ...
  async rpcSubscribe(e, t, i3) {
    ...
    try {
      ...
      if ((i3 == null ? void 0 : i3.transportType) === Q.link_mode)
        return setTimeout(() => {
      ...
      if (this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(C2.connection_stalled), o2)
        throw a2;
    }
    return null;
  }
...
var Si2 = class extends d {
  ...
  async registerEventListeners() {
    ...
    Ua(async (t) => {
      ...
      if (!this.transportExplicitlyClosed && !this.connected && Ta())
        try {
...
function ye2(r2, e, t, i3) {
  ...
  if (s === xi2 && (s = Je2), n2 === xi2 && (n2 = Je2), s !== n2)
    return false;
  switch (s) {
    case no2:
  ...
  try {
    switch (s) {
      case lo2: {
        if (r2.size !== e.size)
          return false;
        for (const [c3, h4] of r2.entries())
          if (!e.has(c3) || !pe2(h4, e.get(c3), c3, r2, e, t, i3))
            return false;
        return true;
      }
      case uo2: {
      ...
      case So2: {
        if (typeof Buffer < "u" && Buffer.isBuffer(r2) !== Buffer.isBuffer(e) || r2.length !== e.length)
          return false;
        for (let c3 = 0; c3 < r2.length; c3++)
          if (!pe2(r2[c3], e[c3], c3, r2, e, t, i3))
            return false;
        return true;
      }
      case yo2:
      ...
      case Je2: {
        if (!(ye2(r2.constructor, e.constructor, t, i3) || Oi2(r2) && Oi2(e)))
          return false;
        const h4 = [...Object.keys(r2), ...Ri2(r2)], l3 = [...Object.keys(e), ...Ri2(e)];
        if (h4.length !== l3.length)
          return false;
...
var Li2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      if (this.pairings.keys.includes(n2)) {
        if (l3 = this.pairings.get(n2), s.addTrace(G2.existing_pairing), l3.active)
          throw s.setError(Y2.active_pairing_already_exists), new Error(`Pairing already exists: ${n2}. Please try again with a new connection URI.`);
  ...
  registerRelayerEvents() {
    this.core.relayer.on(C2.message, async (e) => {
      ...
      if (this.pairings.keys.includes(t) && s !== Q.link_mode && !this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i3)))
        try {
            ...
            if (I4.data && typeof I4.data == "string")
              try {
                ...
                if (D3.type === "verify_attestation") {
                  if (sn(D3.attestation).payload.id !== o2)
                    return;
...
var be2 = (r2, e) => {
  for (var t in e || (e = {}))
    Go2.call(e, t) && Ze2(r2, t, e[t]);
  if (Ki2)
    for (var t of Ki2(e))
      Wo2.call(e, t) && Ze2(r2, t, e[t]);
  return r2;
};
...
var Bi2 = class extends R {
  constructor(e, t, i3 = true) {
    super(e, t, i3), this.core = e, this.logger = t, E2(this, "context", ei2), E2(this, "storagePrefix", B), E2(this, "storageVersion", Qt2), E2(this, "events", /* @__PURE__ */ new Map()), E2(this, "shouldPersist", false), E2(this, "init", async () => {
      ...
      if (a2)
        return be2(be2({}, a2), this.setMethods(a2.eventId));
...
var v3 = (S5, n2) => {
  for (var e in n2 || (n2 = {}))
    qs3.call(n2, e) && Ue2(S5, e, n2[e]);
  if (ft2)
    for (var e of ft2(n2))
      Ps2.call(n2, e) && Ue2(S5, e, n2[e]);
  return S5;
};
...
var Ns2 = class extends V2 {
  constructor(n2) {
    super(n2), c2(this, "name", dt2), c2(this, "events", new import_events4.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time3.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      if (w3)
        return await this.sendRequest({ clientRpcId: a2, relayRpcId: l3, topic: i3, method: d3, params: { request: b2(v3({}, s), { expiryTimestamp: Ei(r2) }), chainId: t }, expiry: r2, throwOnFailedPublish: true, appLink: w3 }).catch((_2) => u3(_2)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), await p4();
      ...
      const { topic: t } = e;
      if (this.client.session.keys.includes(t))
        await this.sendRequest({ topic: t, method: "wc_sessionDelete", params: Nt("USER_DISCONNECTED"), throwOnFailedPublish: true }), await this.deleteSession({ topic: t, emitEvent: false });
      ...
      try {
        if (i3) {
          ...
          await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K4, expiry: e.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q4, expiry: N.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q4.id })]);
      } catch (x2) {
      ...
      if (!r2)
        throw i3.setError(sr2.authenticated_session_pending_request_not_found), new Error(`Could not find pending auth request with id ${t}`);
      ...
      if (!Et(i3) && Oe(i3) !== 0 && this.validateNamespaces(i3, "optionalNamespaces"), Et(r2) || this.validateSessionProps(r2, "sessionProperties"), !Et(o2)) {
        ...
        if (!Object.keys(o2).every((p4) => l3.includes(p4)))
          throw new Error(`Scoped properties must be a subset of required/optional namespaces, received: ${JSON.stringify(o2)}, required/optional namespaces: ${JSON.stringify(l3)}`);
      }
      ...
      if (!ma(e))
        throw new Error(ht("MISSING_OR_INVALID", `approve() params: ${e}`).message);
      ...
      if (Et(r2) || this.validateSessionProps(r2, "sessionProperties"), !Et(o2)) {
        ...
        if (!Object.keys(o2).every((u3) => h4.has(u3)))
          throw new Error(`Scoped properties must be a subset of approved namespaces, received: ${JSON.stringify(o2)}, approved namespaces: ${Array.from(h4).join(", ")}`);
      }
      ...
      if ([...new Set(t.map((a2) => Ne(a2).namespace))].length > 1)
      ...
      try {
        ...
        const i3 = t[s.key];
        if (se(i3))
          return e === "solana_signAllTransactions" ? i3.map((r2) => Ji(r2)) : i3;
        if (typeof i3 == "string")
          return [i3];
      } catch (s) {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(M2.expired, async (n2) => {
      ...
      if (t && this.client.pendingRequest.keys.includes(t))
        return await this.deletePendingSessionRequest(t, ht("EXPIRED"), true);
      if (t && this.client.auth.requests.keys.includes(t))
        return await this.deletePendingAuthRequest(t, ht("EXPIRED"), true);
...
function _t3(s) {
  if (k4(s))
    return s;
  if (Array.isArray(s) || W2(s) || s instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && s instanceof SharedArrayBuffer)
    return s.slice(0);
...
function $3(s, t, e, i3 = /* @__PURE__ */ new Map(), n2 = void 0) {
  ...
  if (Array.isArray(s)) {
    ...
    i3.set(s, r2);
    for (let c3 = 0; c3 < s.length; c3++)
      r2[c3] = $3(s[c3], c3, e, i3, n2);
  ...
  if (s instanceof Map) {
    ...
    i3.set(s, r2);
    for (const [c3, o2] of s)
      r2.set(c3, $3(o2, c3, e, i3, n2));
    return r2;
  }
  if (s instanceof Set) {
...
function F3(s, t, e, i3) {
  if (k4(s) && (s = Object(s)), t == null || typeof t != "object")
    return s;
  if (i3.has(t))
    return _t3(i3.get(t));
  ...
  for (let a2 = 0; a2 < n2.length; a2++) {
    const r2 = n2[a2];
    let c3 = t[r2], o2 = s[r2];
    if (dt3(c3) && (c3 = { ...c3 }), dt3(o2) && (o2 = { ...o2 }), typeof Buffer < "u" && Buffer.isBuffer(c3) && (c3 = pt3(c3)), Array.isArray(c3))
...
var L2 = (s, t) => {
  for (var e in t || (t = {}))
    pe3.call(t, e) && lt2(s, e, t[e]);
  if (ut3)
    for (var e of ut3(t))
      de3.call(t, e) && lt2(s, e, t[e]);
  return s;
};
...
var yt3 = (s, t) => {
  for (var e in t || (t = {}))
    ye3.call(t, e) && X2(s, e, t[e]);
  if (wt3)
    for (var e of wt3(t))
      be3.call(t, e) && X2(s, e, t[e]);
  return s;
};
...
var x = (s, t) => {
  for (var e in t || (t = {}))
    Te2.call(t, e) && Y3(s, e, t[e]);
  if (It3)
    for (var e of It3(t))
      ts2.call(t, e) && Y3(s, e, t[e]);
  return s;
};
...
var B2 = class _B {
  ...
  async cleanupStorage() {
    ...
    try {
      ...
      for (const i3 of e)
        i3.startsWith(U3) && await this.client.core.storage.removeItem(i3);
    } catch (e) {
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-FAE56YYP.js");
  return s;
};
...
var v4 = (s, t) => {
  for (var e in t || (t = {}))
    Q3.call(t, e) && _(s, e, t[e]);
  if (M4)
    for (var e of M4(t))
      V5.call(t, e) && _(s, e, t[e]);
  return s;
};
...
function G3(s) {
  ...
  if (!e && !o2 && !i3 && !(l3 != null && l3.length) && !(r2 != null && r2.length))
...
var R4 = (s, t) => {
  for (var e in t || (t = {}))
    X3.call(t, e) && T2(s, e, t[e]);
  if (S4)
    for (var e of S4(t))
      J3.call(t, e) && T2(s, e, t[e]);
  return s;
};
var Z2 = (s, t) => B3(s, F4(t));
function tt3(s) {
  if (s)
    return { "--w3m-font-family": s["--wcm-font-family"], "--w3m-accent": s["--wcm-accent-color"], "--w3m-color-mix": s["--wcm-background-color"], "--w3m-z-index": s["--wcm-z-index"] ? Number(s["--wcm-z-index"]) : void 0, "--w3m-qr-color": s["--wcm-accent-color"], "--w3m-font-size-master": s["--wcm-text-medium-regular-size"], "--w3m-border-radius-master": s["--wcm-container-border-radius"], "--w3m-color-mix-strength": 0 };
}
var et3 = (s) => {
  const [t, e] = s.split(":");
...
*/
//# sourceMappingURL=index.es-RAGBHGWN.js.map
