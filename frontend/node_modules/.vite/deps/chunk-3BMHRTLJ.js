...
import {
  secp256k1
} from "./chunk-I2TQVZFP.js";
import {
  Chi,
  HashMD,
  Maj
} from "./chunk-YU6FU6IJ.js";
import {
  clean,
  createHasher,
  rotl
} from "./chunk-FC43JDF4.js";
import {
  __export
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-GTRAOMJS.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-6X2X5JJP.js");
  const signature_ = (() => {
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-3BMHRTLJ.js.map
