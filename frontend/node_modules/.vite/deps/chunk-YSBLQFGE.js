  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 50; s2 += 10) {
      for (let c3 = 0; c3 < 10; c3++)
        n2[c3] = t2[s2 + c3];
      for (let c3 = 0; c3 < 10; c3++)
        t2[s2 + c3] ^= ~n2[(c3 + 2) % 10] & n2[(c3 + 4) % 10];
    }
...
function Ns(t2, e2) {
  ...
  return Fe(o2), Fe(s2), Ar(i3), Ar(n2), (c3, a, u2, l4, f6 = 0) => {
    ...
    if (E2 === 32)
      y4.push(p = Ze(c3)), d2 = As;
    else if (E2 === 16 && n2)
      p = new Uint8Array(32), p.set(c3), p.set(c3, 16), d2 = Os, y4.push(p);
    else
...
var Us = class {
  ...
  finalize() {
    ...
    for (let c3 = 2; c3 < 10; c3++)
      e2[c3] += o2, o2 = e2[c3] >>> 13, e2[c3] &= 8191;
    ...
    for (let c3 = 1; c3 < 10; c3++)
      r2[c3] = e2[c3] + o2, o2 = r2[c3] >>> 13, r2[c3] &= 8191;
    r2[9] -= 8192;
    let i3 = (o2 ^ 1) - 1;
    for (let c3 = 0; c3 < 10; c3++)
      r2[c3] &= i3;
    ...
    for (let c3 = 1; c3 < 8; c3++)
      s2 = (e2[c3] + n2[c3] | 0) + (s2 >>> 16) | 0, e2[c3] = s2 & 65535;
    jt(r2);
  }
  update(e2) {
    Or(this);
  ...
  return function(c3, a) {
    ...
    for (; !c3.eql(h4, c3.ONE); ) {
      if (c3.eql(h4, c3.ZERO))
        return c3.ZERO;
      let y4 = 1;
      for (let p = c3.sqr(h4); y4 < u2 && !c3.eql(p, c3.ONE); y4++)
        p = c3.sqr(p);
  ...
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    for (let f6 = 0; f6 < s2; f6++) {
      ...
      if (o2 === Zr)
        break;
      let y4 = Number(o2 & a);
      if (o2 >>= l4, y4 > c3 && (y4 -= u2, o2 += ve), y4 === 0)
        continue;
...
function rr2(r2, e2) {
  ...
  function d2(u2) {
    ...
    for (var H2 = j - x; H2 !== j && T[H2] === 0; )
      H2++;
    for (var me2 = c3.repeat(b); H2 < j; ++H2)
      me2 += r2.charAt(T[H2]);
    return me2;
  }
  function g(u2) {
...
*/
//# sourceMappingURL=chunk-YSBLQFGE.js.map
