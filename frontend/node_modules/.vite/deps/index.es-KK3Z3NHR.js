...
async function Si({ id: t, topic: e, wcDeepLink: n2 }) {
  ...
  try {
    ...
    if (c4 === Y.browser) {
      ...
      c4 === Y.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
  } catch (o2) {
    console.error(o2);
  }
}
  ...
  for (let E7 = 0; E7 < a2; s++) {
    ...
    if (f7 && p4 === ge) {
      ...
      for (let v5 = 0, m2; v5 < Bs; v5++)
        m2 = d3 + v5, y6[m2] = h4[m2] ^ l4[v5];
      E7 += ge;
      continue;
    }
    for (let d3 = 0, v5; d3 < p4; d3++)
      v5 = E7 + d3, i3[v5] = o2[v5] ^ u3[d3];
    E7 += p4;
  }
}
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c4, a2, u3, l4, f7 = 0) => {
    tt(c4), tt(a2), tt(u3);
    const h4 = u3.length;
    if (l4 === void 0 && (l4 = new Uint8Array(h4)), tt(l4), Fe(f7), f7 < 0 || f7 >= Ur)
      throw new Error("arx: counter overflow");
    if (l4.length < h4)
      throw new Error(`arx: output (${l4.length}) is shorter than data (${h4})`);
    const y6 = [];
    let E7 = c4.length, p4, d3;
    if (E7 === 32)
      y6.push(p4 = Ze(c4)), d3 = As;
    else if (E7 === 16 && n2)
      p4 = new Uint8Array(32), p4.set(c4), p4.set(c4, 16), d3 = Os, y6.push(p4);
    else
      throw new Error(`arx: invalid 32-byte key, got length=${E7}`);
...
var Us = class {
  ...
  finalize() {
    ...
    for (let c4 = 1; c4 < 8; c4++)
      s = (e[c4] + n2[c4] | 0) + (s >>> 16) | 0, e[c4] = s & 65535;
    jt(r2);
  }
  update(e) {
    Or(this);
...
function ks(t, e, n2, r2 = 32) {
  ...
  for (let u3 = 0; u3 < o2; u3++)
    Ge[0] = u3 + 1, c4.update(u3 === 0 ? jr : a2).update(n2).update(Ge).digestInto(a2), i3.set(a2, t.outputLen * u3), s._cloneInto(c4);
...
function rc(t) {
  ...
  return function(c4, a2) {
    if (c4.pow(a2, e) === c4.neg(c4.ONE))
      throw new Error("Cannot find square root");
    let u3 = r2, l4 = c4.pow(c4.mul(c4.ONE, o2), n2), f7 = c4.pow(a2, i3), h4 = c4.pow(a2, n2);
    for (; !c4.eql(h4, c4.ONE); ) {
      if (c4.eql(h4, c4.ZERO))
        return c4.ZERO;
      let y6 = 1;
      for (let p4 = c4.sqr(h4); y6 < u3 && !c4.eql(p4, c4.ONE); y6++)
        p4 = c4.sqr(p4);
...
function dc(t, e) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    for (let u3 = 0; u3 < o2; u3++) {
      a2 = c4, s.push(a2);
      for (let l4 = 1; l4 < i3; l4++)
        a2 = a2.add(c4), s.push(a2);
      c4 = a2.double();
    }
    return s;
  }, wNAF(n2, r2, o2) {
    ...
    for (let f7 = 0; f7 < s; f7++) {
      ...
      if (o2 === Zr)
        break;
      let y6 = Number(o2 & a2);
      if (o2 >>= l4, y6 > c4 && (y6 -= u3, o2 += ve), y6 === 0)
        continue;
...
function hc(t, e, n2, r2) {
  ...
  for (let f7 = u3; f7 >= 0; f7 -= s) {
    ...
    let h4 = o2;
    for (let y6 = a2.length - 1, E7 = o2; y6 > 0; y6--)
      E7 = E7.add(a2[y6]), h4 = h4.add(E7);
    if (l4 = l4.add(h4), f7 !== 0)
      for (let y6 = 0; y6 < s; y6++)
        l4 = l4.double();
  }
  return l4;
}
...
function Ac(t) {
  ...
  class h4 {
    ...
    multiplyUnsafe(d3) {
      ...
      if (this.is0() || d3 === K)
        return this;
      if (!v5 || E7.hasPrecomputes(this))
        return E7.wNAFCachedUnsafe(this, d3, h4.normalizeZ);
...
function zc(t, e) {
  ...
  if (!_c.verify(concat([s, c4]), u3, l4))
...
function aa(t, e) {
  ...
  for (const h4 of f7)
    l4[h4] = { chains: ot((n2 = a2[h4]) == null ? void 0 : n2.chains, (r2 = u3[h4]) == null ? void 0 : r2.chains), methods: ot((o2 = a2[h4]) == null ? void 0 : o2.methods, (i3 = u3[h4]) == null ? void 0 : i3.methods), events: ot((s = a2[h4]) == null ? void 0 : s.events, (c4 = u3[h4]) == null ? void 0 : c4.events) };
  return l4;
}
...
function rr2(r2, e) {
  ...
  function d3(u3) {
    ...
    if (u3.length === 0)
      return "";
    for (var b5 = 0, x3 = 0, I4 = 0, D4 = u3.length; I4 !== D4 && u3[I4] === 0; )
      I4++, b5++;
    for (var j4 = (D4 - I4) * l4 + 1 >>> 0, T3 = new Uint8Array(j4); I4 !== D4; ) {
      for (var q4 = u3[I4], J4 = 0, K5 = j4 - 1; (q4 !== 0 || J4 < x3) && K5 !== -1; K5--, J4++)
        q4 += 256 * T3[K5] >>> 0, T3[K5] = q4 % a2 >>> 0, q4 = q4 / a2 >>> 0;
      if (q4 !== 0)
        throw new Error("Non-zero carry");
      x3 = J4, I4++;
    }
    for (var H4 = j4 - x3; H4 !== j4 && T3[H4] === 0; )
      H4++;
    for (var me4 = c4.repeat(b5); H4 < j4; ++H4)
      me4 += r2.charAt(T3[H4]);
    return me4;
  }
  function g(u3) {
    ...
    var b5 = 0;
    if (u3[b5] !== " ") {
      for (var x3 = 0, I4 = 0; u3[b5] === c4; )
        x3++, b5++;
      for (var D4 = (u3.length - b5) * h4 + 1 >>> 0, j4 = new Uint8Array(D4); u3[b5]; ) {
        var T3 = t[u3.charCodeAt(b5)];
        if (T3 === 255)
          return;
        for (var q4 = 0, J4 = D4 - 1; (T3 !== 0 || q4 < I4) && J4 !== -1; J4--, q4++)
          T3 += a2 * j4[J4] >>> 0, j4[J4] = T3 % 256 >>> 0, T3 = T3 / 256 >>> 0;
        if (T3 !== 0)
          throw new Error("Non-zero carry");
        I4 = q4, b5++;
      }
      if (u3[b5] !== " ") {
        for (var K5 = D4 - I4; K5 !== D4 && j4[K5] === 0; )
          K5++;
        for (var H4 = new Uint8Array(x3 + (D4 - K5)), me4 = x3; K5 !== D4; )
          H4[me4++] = j4[K5++];
        return H4;
      }
    }
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      if (Fc(a2))
        return Dc(c4, o2 == null ? void 0 : o2.encoding);
      if (Kc(a2)) {
    ...
    switch (s) {
      case lo2: {
        ...
        for (const [c4, h4] of r2.entries())
          if (!e.has(c4) || !pe2(h4, e.get(c4), c4, r2, e, t, i3))
            return false;
        return true;
      }
      case uo2: {
      ...
      case So2: {
        if (typeof Buffer < "u" && Buffer.isBuffer(r2) !== Buffer.isBuffer(e) || r2.length !== e.length)
          return false;
        for (let c4 = 0; c4 < r2.length; c4++)
          if (!pe2(r2[c4], e[c4], c4, r2, e, t, i3))
            return false;
        return true;
      }
      case yo2:
  ...
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      if (this.pairings.keys.includes(n2)) {
        if (l4 = this.pairings.get(n2), s.addTrace(G2.existing_pairing), l4.active)
            ...
            if (I4.data && typeof I4.data == "string")
              try {
                ...
                if (D4.type === "verify_attestation") {
                  if (sn(D4.attestation).payload.id !== o2)
                    return;
...
var Ns2 = class extends V2 {
  constructor(n2) {
    super(n2), c3(this, "name", dt2), c3(this, "events", new import_events4.default()), c3(this, "initialized", false), c3(this, "requestQueue", { state: $2.idle, queue: [] }), c3(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c3(this, "requestQueueDelay", import_time3.ONE_SECOND), c3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedLimit", 200), c3(this, "relayMessageCache", []), c3(this, "pendingSessions", /* @__PURE__ */ new Map()), c3(this, "init", async () => {
      ...
      if (w3)
        return await this.sendRequest({ clientRpcId: a2, relayRpcId: l4, topic: i3, method: d3, params: { request: b2(v3({}, s), { expiryTimestamp: Ei(r2) }), chainId: t }, expiry: r2, throwOnFailedPublish: true, appLink: w3 }).catch((_3) => u3(_3)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), await p4();
      ...
      try {
        if (i3) {
          ...
          await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K5, expiry: e.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q4, expiry: N2.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q4.id })]);
      } catch (x3) {
      ...
      if (!Et(i3) && Oe(i3) !== 0 && this.validateNamespaces(i3, "optionalNamespaces"), Et(r2) || this.validateSessionProps(r2, "sessionProperties"), !Et(o2)) {
        ...
        if (!Object.keys(o2).every((p4) => l4.includes(p4)))
          throw new Error(`Scoped properties must be a subset of required/optional namespaces, received: ${JSON.stringify(o2)}, required/optional namespaces: ${JSON.stringify(l4)}`);
      }
...
function F3(s, t, e, i3) {
  if (k5(s) && (s = Object(s)), t == null || typeof t != "object")
    return s;
  if (i3.has(t))
    return _t3(i3.get(t));
  ...
  for (let a2 = 0; a2 < n2.length; a2++) {
    const r2 = n2[a2];
    let c4 = t[r2], o2 = s[r2];
    if (dt3(c4) && (c4 = { ...c4 }), dt3(o2) && (o2 = { ...o2 }), typeof Buffer < "u" && Buffer.isBuffer(c4) && (c4 = pt3(c4)), Array.isArray(c4))
...
var D3 = async () => {
  const { createAppKit: s } = await import("./core-O2SNF7XZ.js");
  return s;
};
...
var v4 = (s, t) => {
  for (var e in t || (t = {}))
    Q3.call(t, e) && _2(s, e, t[e]);
  if (M4)
    for (var e of M4(t))
      V5.call(t, e) && _2(s, e, t[e]);
  return s;
};
...
function G3(s) {
  ...
  if (!e && !o2 && !i3 && !(l4 != null && l4.length) && !(r2 != null && r2.length))
...
*/
//# sourceMappingURL=index.es-KK3Z3NHR.js.map
